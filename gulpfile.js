...
gulp.task('copy:images', ['clean:images'], function() {
	return gulp.src(dir.app + '/res/images/*.{svg,png,gif,jpg,jpeg}')
	.pipe(gulp.dest(dir.dev + '/res/'));
});
...
gulp.task('clean:images', function() {
	del.sync(dir.dev + '/res/images/*.{svg,png,gif,jpg,jpeg}');
});
...
gulp.task('watch', ['build'], function() {
	...
	gulp.watch(dir.app + '/res/images/*.{svg,png,gif,jpg,jpeg}', ['copy:images']);
